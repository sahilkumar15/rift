...
by src.train.train_rift_rl.train().
"""
...
def _flat_train_cfg(cfg):
    ...
    data_cfg.setdefault("batch_size", cfg.get_dotted("data.batch_size", 8))
    data_cfg.setdefault("num_workers", cfg.get_dotted("data.num_workers", 0))
    data_cfg.setdefault("prefetch_factor", cfg.get_dotted("data.prefetch_factor", 2))
    data_cfg.setdefault("pin_memory", cfg.get_dotted("data.pin_memory", True))
    data_cfg.setdefault("persistent_workers", cfg.get_dotted("data.persistent_workers", True))
    ...
    val_max_items = _maybe_int(cfg.get_dotted("data.val_max_items", None))
    ...
    return Config(
        {
            ...
            "hidden": cfg.get_dotted("rl.hidden", cfg.get("hidden", 256)),
            "feat_dim": cfg.get_dotted("rl.feat_dim", cfg.get("feat_dim", 1024)),
            ...
            "constraint_budget": cfg.get_dotted(
            ...
            "val_every": cfg.get_dotted("rl.val_every", cfg.get("val_every", 1)),
            "val_max_batches": cfg.get_dotted("rl.val_max_batches", cfg.get("val_max_batches", 0)),
            "cache_features": cfg.get_dotted("rl.cache_features", cfg.get("cache_features", True)),
